    ...
    var mouseUpHandler = function(e){
      ...
      if(obj){
        if(obj.small){    
          ...
          //make four smaller marshmallows and shoot them in random directions
          geomId++;
          var marsh1 = new Marshmallow(
                  {id: geomId, x: obj.x - obj.halfHeight/2, y: obj.y - obj.halfHeight/2, halfHeight: obj.halfHeight/2, halfWidth: obj.halfWidth/2, 
                  img : marshImg,statidBody: false, restitution: 0.5, small: true}
                  );        
          box.addBody(marsh1); 
          world[geomId] = marsh1;
          box.applyImpulse(marsh1.id, Math.random() * 360, 25);
          
          geomId++;
          var marsh2 = new Marshmallow(
                  {id: geomId, x: obj.x + obj.halfHeight/2, y: obj.y + obj.halfHeight/2, halfHeight: obj.halfHeight/2, halfWidth: obj.halfWidth/2, 
                  img : marshImg,statidBody: false, restitution: 0.5, small: true}
                  );
          box.addBody(marsh2); 
          world[geomId] = marsh2;
          box.applyImpulse(marsh2.id, Math.random() * 360, 25);
          
          geomId++;
          var marsh3 = new Marshmallow(
                  {id: geomId, x: obj.x - obj.halfHeight/2, y: obj.y + obj.halfHeight/2, halfHeight: obj.halfHeight/2, halfWidth: obj.halfWidth/2, 
                  img : marshImg,statidBody: false, restitution: 0.5, small: true}
                  );
          box.addBody(marsh3); 
          world[geomId] = marsh3;
          box.applyImpulse(marsh3.id, Math.random() * 360, 25);
          
          geomId++;
          var marsh4 = new Marshmallow(
                  {id: geomId, x: obj.x + obj.halfHeight/2, y: obj.y - obj.halfHeight/2, halfHeight: obj.halfHeight/2, halfWidth: obj.halfWidth/2, 
                  img : marshImg,statidBody: false, restitution: 0.5, small: true}
                  );
          box.addBody(marsh4); 
          world[geomId] = marsh4;
          box.applyImpulse(marsh4.id, Math.random() * 360, 25);
        }
          ...
          try{
            ...
            if(millisToMarshPassed > millisToMarsh){
              ...
              var marsh = new Marshmallow(
                {id: geomId, x: Math.random() * 16 + 3, y: (Math.random() * 10) - 10, halfHeight: (marshSize/SCALE)/2, halfWidth: (marshSize/SCALE)/2, 
